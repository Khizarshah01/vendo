...
import { VendoOverlay, VendoThread, type VendoThreadProps } from "../../../src/ui/chrome/index.js";
import {
  escapeIntent,
  expandedStageRect,
  featuredEmbed,
  ...
  useSplitView,
  type SplitViewState,
} from "../../../src/ui/chrome/split-view.js";
...
describe("splitViewReducer (state machine)", () => {
  ...
  it("expandedStageRect mirrors the chrome-css split-view constants (the FLIP ghost's target)", async () => {
    ...
    const { CHROME_CSS } = await import("../../../src/ui/chrome/chrome-css.js");
