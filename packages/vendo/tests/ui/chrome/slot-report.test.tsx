...
import { SLOT_DESCRIPTION_MAX_CHARS, SLOT_REPORT_REFRESH_MS } from "../../../src/core/index.js";
import { cleanup, render, waitFor } from "@testing-library/react";
import { afterEach, beforeEach, describe, expect, it, vi } from "vitest";
import { VendoProvider, createVendoClient, type VendoClient } from "../../../src/ui/index.js";
import { VendoSlot } from "../../../src/ui/chrome/index.js";
...
describe("a mounted VendoSlot reports itself to the registry", () => {
  ...
  it("holds a late-mounting slot's report while forbidden, and sends it on the identity signal", async () => {
    const { identityState } = await import("../../../src/ui/hooks/identity-state.js");
    const { VendoError } = await import("../../../src/core/index.js");
  ...
  it("a report-only slot held while forbidden lands on the identity signal", async () => {
    const { identityState } = await import("../../../src/ui/hooks/identity-state.js");
    const { useReportSlot } = await import("../../../src/ui/hooks/use-placements.js");
    const { VendoError } = await import("../../../src/core/index.js");
    identityState(client).note(new VendoError("forbidden", "no identity for this request"));
    function ReportOnly() {
