...
import { effectiveAppBuildUiDeadlineMs } from "../../src/core/apps/index.js";
import type { VendoAppRef, VendoApprovalRef } from "../../src/core/index.js";
...
describe("existing-agents embeds", () => {
  ...
  describe("VendoApprovalEmbed", () => {
     ...
     *  `@vendoai/vendo/core` (the ESM build beside the CJS one), and the second
