...
import { Badge } from "../../../src/ui/kit/data/badge.js";
import { Stat } from "../../../src/ui/kit/data/stat.js";
import { Callout } from "../../../src/ui/kit/feedback/callout.js";
import { Card, Grid, Row, Stack, Surface } from "../../../src/ui/kit/layout.js";
import { toneColor } from "../../../src/ui/kit/tokens.js";
import { EnumBadge, Text } from "../../../src/ui/kit/values.js";
...
describe("grow — the child that claims what is left", () => {
  ...
  it("every container takes the adjective", () => {
    ...
    for (const [name, node] of containers) {
      ...
      // Parsed, not string-compared: the FLOOR is the claim, and jsdom serializes
      // the same zero as "0" or "0px" depending on its version.
      expect(parseFloat(kit(container, name).style.minWidth), name).toBe(0);
    }
  });
