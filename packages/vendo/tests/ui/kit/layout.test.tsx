...
import { Card, SplitPane } from "../../../src/ui/kit/layout.js";
...
describe("SplitPane", () => {
  ...
  it("gives every pane its own scroll and a zero floor", () => {
    ...
    for (const one of panes) {
      ...
      // Parsed, not string-compared — see tests/ui/kit/adjectives.test.tsx.
      expect(parseFloat(one.style.minWidth)).toBe(0);
    }
  });
