...
import { backends } from "../../src/store/backends.test-util.js";
import { createStore, grantStore, threadStore } from "../../src/store/index.js";
...
for (const backend of backends()) {
  describe(backend.name, () => {
    ...
    it("recovers fully awaited writes after an ungraceful SIGKILL", async () => {
      ...
      dirs.push(dataDir);
      const fixture = new URL("../../src/store/__fixtures__/drill-writer.mjs", import.meta.url);
