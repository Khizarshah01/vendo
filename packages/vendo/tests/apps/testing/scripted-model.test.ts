/**
 * The scripted model fixture — SHIPPED code (`@vendoai/vendo/apps/testing`), and the
...
import { basicLanguageModel, scriptedLanguageModel, type ScriptedModelCall } from "../../../src/apps/testing/scripted-model.js";
