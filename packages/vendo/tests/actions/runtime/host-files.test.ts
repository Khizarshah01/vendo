...
import { readOptionalVendoJson } from "../../../src/actions/runtime/host-files.js";
import { readOptionalVendoJson as readOnEdge } from "../../../src/actions/runtime/host-files-edge.js";
...
describe("host config files, edge entry", () => {
  ...
  it("keeps the edge module free of node builtins", async () => {
    ...
    const source = await readFile(new URL("../../../src/actions/runtime/host-files-edge.ts", import.meta.url), "utf8");
