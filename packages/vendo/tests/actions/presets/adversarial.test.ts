...
import {
  ...
  genericJwtPreset,
  supabasePreset,
} from "../../../src/actions/presets/index.js";
// authJsPreset lives on its own module (not the barrel) — see index.ts.
import { authJsPreset } from "../../../src/actions/presets/auth-js.js";
import { signHs256 } from "../../../src/actions/presets/shared.js";

// Red-team suite for @vendoai/vendo/actions/presets. actAs material is host
