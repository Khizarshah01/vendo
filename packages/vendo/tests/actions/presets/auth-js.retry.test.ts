...
function mockAuthCoreMissing(): void {
  vi.doMock("@auth/core/jwt", () => {
    const error = new Error(
      "Cannot find package '@auth/core' imported from packages/vendo/src/actions/presets/auth-js.ts",
...
async function loadPreset(): Promise<typeof import("../../../src/actions/presets/auth-js.js")> {
  return await import("../../../src/actions/presets/auth-js.js");
}
