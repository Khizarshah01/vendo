...
import { composioToolRisk } from "../../../src/actions/connectors/composio-risk.js";
import { walk } from "../../../src/actions/sync/common.js";
import { extractedRisk, trpcRisk } from "../../../src/actions/sync/common.js";
...
describe("no code path grades a tool from its NAME (D1, AC1)", () => {
  ...
  it("keeps every word list OUT of extraction and the connectors, which is what D1 governs", async () => {
    const graders = await walk(fileURLToPath(new URL("../../../src/actions/", import.meta.url)), (relative) =>
