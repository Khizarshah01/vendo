...
import type { AppAccess, AppId } from "../../../src/core/index.js";
import { appAccessConformance, memoryAppAccess, runConformance } from "../../../src/core/conformance/index.js";
 ...
 * @vendoai/vendo/apps each mount this kit too, over real rows — this suite proves the
