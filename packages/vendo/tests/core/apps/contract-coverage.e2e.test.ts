 ...
 * now and `@vendoai/vendo/core`'s own suite may not reach up to them. The bodies are
 * unchanged — only the file and the import specifier are.
 */
import { describe, expect, it } from "vitest";
import * as contract from "../../../src/core/apps/index.js";
import {
  treeQuerySchema,
  treeSchema,
  validateTree,
...
import { treeNodeSchema, uiPayloadSchema } from "../../../src/core/index.js";
...
describe("public export surface — the app-format schemas moved off @vendoai/vendo/core", () => {
