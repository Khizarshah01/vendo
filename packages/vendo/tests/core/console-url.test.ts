...
import type { VendoLogEvent } from "../../src/core/log.js";
...
async function freshModule() {
  ...
  const { setLogger } = await import("../../src/core/log.js");
  setLogger((event) => events.push(event));
  const { consoleUrlFromEnv } = await import("../../src/core/console-url.js");
