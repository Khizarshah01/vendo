 ...
 * implementations (`packages/vendo/src/ui/tree/display-bricks.tsx`) take exactly two
 ...
 * of a security boundary is the copy that drifts: `@vendoai/vendo/ui` filters every
