 ...
 * `@vendoai/vendo/store` (which moves an app between mounts) and `@vendoai/vendo/apps`
 ...
 *  readers: `@vendoai/vendo/store`'s workspace rows and `@vendoai/vendo/apps`'s app source
