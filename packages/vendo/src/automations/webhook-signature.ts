...
const decodeBase64 = (value: string, url = false) => {
  try {
...
export const verifySignature = async (
  ...
  try {
    ...
    return await globalThis.crypto.subtle.verify(
      ...
      // WebCrypto accepts any ArrayBufferView at runtime. This package kept
      // `lib: ["ES2022"]` before the fold, where the gap did not exist.
