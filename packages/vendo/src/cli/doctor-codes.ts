...
export const DOCTOR_ERROR_CODES = {
  ...
  "E-CFG-004": "the Next host's next.config does not keep PGlite and esbuild out of the server bundle (serverExternalPackages)",
  ...
  "E-UI-001": "RETIRED — `vendo eject` was removed, so no surface can drift from the installed @vendoai/vendo/ui",
