/**
 * `@vendoai/vendo/apps` — the app engine, node-only.
 *
...
export type { SandboxAdapter, SandboxMachine, SandboxResumePolicy } from "../sandbox/escalation/sandbox.js";
export {
  shareSnapshotSchema,
  publishRecordSchema,
 ...
 * `@vendoai/vendo/apps` subpath. The emitted-payload assembly and the field
...
export { e2bInstalled, e2bSandbox, type E2BSandboxOptions } from "../sandbox/escalation/e2b/index.js";
export {
  selectSandbox,
  type CloudSandboxRung,
  type SandboxSelection,
  type SandboxVenue,
} from "../sandbox/escalation/sandbox-ladder.js";
