...
/** @vendoai/vendo/ui — provider, hooks, client (headless, no styles).
 *
...
// a BYO chat page needs only `@vendoai/vendo/ui`.
...
// as a direct dependency, and the "@vendoai/vendo/ui/chrome" subpath does not resolve
