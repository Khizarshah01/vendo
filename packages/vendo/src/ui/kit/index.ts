...
/**
 * @vendoai/vendo/ui/kit — the Kit (W2 §The Kit).
 *
...
// it — reachable from a generated app's box, where `@vendoai/vendo/ui`'s root barrel
...
export type { Json, ReshapeOp, ReshapeResult, ReshapeStep, ToolOutcome } from "../../core/index.js";
