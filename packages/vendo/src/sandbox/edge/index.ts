/**
 * `@vendoai/vendo/sandbox/edge` — the screen toolchain for a venue that is not Node.
 *
 ...
 * import { edgeToolchain } from "./index.js";
 *
 ...
 * installs them. Nothing in `@vendoai/vendo/apps`'s own entry points reaches this
