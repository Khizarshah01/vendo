 ...
 * It lives in core because BOTH readers need it and neither owns it: ui renders
 * the theme in the host page, the door renders it here. One definition, two
 * readers — see packages/vendo/tests/theme-seam.test.ts. */
