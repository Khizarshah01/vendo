...
import type { NormalizedCatalogEntry } from "../../src/apps/catalog.js";
import { HOST_COMPONENTS_MOUNT, componentPath, hostComponentFiles } from "../../src/apps/host-components.js";
