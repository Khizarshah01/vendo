...
vi.mock("../src/judge/pass.js", () => ({ runJudgmentPass }));

const selectJudgmentEngines = vi.hoisted(() => vi.fn());
vi.mock("../src/judge/engine.js", () => ({ selectJudgmentEngines }));

const runProseStages = vi.hoisted(() => vi.fn());
vi.mock("../src/init-judgment.js", () => ({ runProseStages }));

const { runSyncFlow } = await import("../src/sync-flow.js");
