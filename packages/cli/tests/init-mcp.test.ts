...
import { doorWellKnownPaths } from "@vendoai/vendo/server";
import { compositionSpecifier, routeSource } from "../src/init-scaffolds.js";
import { OWN_SEAM_RECIPE, generateServiceKey, planMcp, wellKnownRouteSource, type McpPlan, type McpPlanInput } from "../src/init-mcp.js";
