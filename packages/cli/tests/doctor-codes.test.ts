...
import { DOCTOR_ERROR_CODES, TROUBLESHOOTING_URL, doctorErrorCodes, doctorFixRef } from "../src/doctor-codes.js";
import { CLI_VERSION } from "../src/shared.js";
    ...
    expect(DOCTOR_ERROR_CODES).toMatchInlineSnapshot(`
      {
        ...
        "E-CFG-004": "the Next host's next.config does not keep @vendoai/vendo/apps out of the server bundle (serverExternalPackages)",
